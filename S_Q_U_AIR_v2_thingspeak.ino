...
const char* thingSpeakApiKey = "G4UUJZ6JL1OE9ATW";
...
//#define PMS_RX_PIN D10
//#define PMS_TX_PIN D11
...
//  SD.begin(SD_CS_PIN, SPI, 4000000) 
...
if (WiFi.status() == WL_CONNECTED) {
  ...
  if (httpCode > 0) {
    ...
    Serial.printf("ThingSpeak send failed: %s\n", http.errorToString(httpCode).c_str());
  }
  http.end();
}
